...
namespace erp.Controllers
{
    ...
    public class RoleController : Controller
    {
            ...
            try
            {
                if (CheckExistRole(entity))
                {
                    ...
                    var activity = new TrackingUser
                    {
                        ...
                        Value = entity.Alias,
                        Description = entity.Alias + Constants.Flag + entity.Description
                    };
        ...
        {
            return dbContext.Roles.Find(m => m.Enable.Equals(true) && m.Alias.Equals(entity.Alias)).Count() > 0 ? false : true;
        }
